...
// struct that stores a city, state
struct name{
    ...
    // constructor
    name(string c="nowhere", string s="nostate") : city(c), state(s) {}
...
int main(){
    ...
    cout << endl;
    cout << "Search by state (Pennsylvania)" << endl;
    my_list.find_by_state("pennsylvania");

    // example of search-by-city
    cout << endl;
    cout << "Search by city (Topeka)" << endl;
