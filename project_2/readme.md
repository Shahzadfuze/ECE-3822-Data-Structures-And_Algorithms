...
## Purpose
The purpose of Project 2 is to practice using objects and re-using pre-written linked-list code.
...
## Goals
Your goal is to get the following three functions to work:

### `clients.print_all()`
print all the customer information in this format:

Customer 724 watched 225, 502, 109  
Customer 449 watched 109, 305

### `clients.print_customer(customerID)`
print the information for a specific customer in this format:

Customer 724 watched 225, 502, 109

### `clients.print_views(movieID)`
print the number of customers who watched a movie in this format:
...
grab them all. Be sure to test your code with more examples than just the ones
specified above.
