...
def main():
    ...
    # studentlist[username]  + "_" + username
...
def rsync_files(target_dir):
    ...
    cmd_rsync += "--include=""lab_01.cpp"""     + " "
    cmd_rsync += "--include=""lab_01.py"""      + " "
    cmd_rsync += "--include=""books.h"""        + " "
    cmd_rsync += "--include=""books.cpp"""      + " "
    cmd_rsync += "--include=""books.py"""       + " "
